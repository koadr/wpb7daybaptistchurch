...
//			console.log('resize');
			...
			if (cw > 767) {
				if(jQuery('#jcyclemain .jcyclemain:visible .cycle_image').length){
					...
					var ih = (jQuery('#jcyclemain .jcyclemain:visible ').attr('data-slidesize')-110);
			...
			jQuery("#jcyclemain").stop().animate({height:(nh+110)+'px'});
		}
    ...
    function animateSlideContent(currElement, nextElement, opts, isForward) {
		...
		if (cw > 767)
		{
			...
			else
			{
				...
				{
					var ih = (jQuery(nextElement).attr('data-slidesize')-110);
