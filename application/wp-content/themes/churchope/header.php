...
<?php dynamic_sidebar("header") ?>
		...
		<section id="color_header" class="clearfix">
			<div class="mainmenu <?php echo (get_option(SHORTNAME . "_menu_left"))?'menu_left':''; ?>"><div class="row clearfix"><div class="grid_12">
<?php
wp_nav_menu(array('theme_location' => 'header-menu', 'container_class' => 'main_menu', 'menu_class' => 'sf-menu', 'fallback_cb' => '', 'container' => 'nav', 'link_before' => '', 'link_after' => '', 'walker' => new Walker_Nav_Menu_Sub()));
